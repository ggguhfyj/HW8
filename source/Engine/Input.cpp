...
{
Input::Input()
    : keys_down(static_cast<size_t>(Keys::Count), false),
      previous_keys_down(static_cast<size_t>(Keys::Count), false)
{}
...
SDL_Scancode Input::convert_cs230_to_sdl(CS230::Input::Keys cs230_key)
{
    switch (cs230_key)
    {
        ...
        case CS230::Input::Keys::Numpad4: return SDL_SCANCODE_KP_4;
        case CS230::Input::Keys::Numpad5: return SDL_SCANCODE_KP_5;
        case CS230::Input::Keys::Numpad6: return SDL_SCANCODE_KP_6;
        case CS230::Input::Keys::Numpad8: return SDL_SCANCODE_KP_8;
